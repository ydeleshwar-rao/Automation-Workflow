...
export function StreamNodeConfig({ config, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="nm-inset rounded-xl p-3 text-[11px] text-blue-400 leading-relaxed">
        Streams tokens in real-time via Server-Sent Events (SSE). Connect to a UI that consumes streaming responses.
      </div>
