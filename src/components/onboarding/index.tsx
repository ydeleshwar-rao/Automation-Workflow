  ...
  return (
    <div className="w-full min-h-screen bg-background">
      ...
      <section className="min-h-screen flex flex-col lg:flex-row">
        ...
        {/* Left Panel */}
        <div className="w-full lg:w-[460px] xl:w-[520px] bg-card text-card-foreground flex flex-col">
          <LoginHeader />

          <div className="flex flex-1 flex-col items-start justify-center px-10 sm:px-16 py-16">
      ...
      {/* SECTION 3 */}
      <section id="feature-section" className="bg-background px-6 py-20 lg:px-16 scroll-mt-4">
